...
public class CustomListener implements ITestListener {
    ...
    public void onTestSuccess(ITestResult iTestResult) {
        ...
        TestRailConnector testRailConnector = new TestRailConnector("https://itstep092018.testrail.io", "alexgomel1987@gmail.com", "Fktrc1987fktrc");

        testRailConnector.sentTestResult(testCaseId, resultId, comment, duration, "14");
    }
